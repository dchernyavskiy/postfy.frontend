...
export function deletePost(http: HttpClient, rootUrl: string, params?: DeletePost$Params, context?: HttpContext): Observable<StrictHttpResponse<StatusCodeResult>> {
...
deletePost.PATH = '/api/v1/network/posts';
