...
export interface ExplorePosts$Params {
  LastPostId?: string;
...
export function explorePosts(http: HttpClient, rootUrl: string, params?: ExplorePosts$Params, context?: HttpContext): Observable<StrictHttpResponse<ExplorePostsResponse>> {
  const rb = new RequestBuilder(rootUrl, explorePosts.PATH, 'get');
  if (params) {
...
explorePosts.PATH = '/api/v1/network/posts/explore';
