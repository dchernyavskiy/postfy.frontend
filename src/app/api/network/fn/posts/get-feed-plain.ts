...
export interface GetFeed$Plain$Params {
...
export function getFeed$Plain(http: HttpClient, rootUrl: string, params?: GetFeed$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<GetFeedResponse>> {
  const rb = new RequestBuilder(rootUrl, getFeed$Plain.PATH, 'get');
  if (params) {
...
getFeed$Plain.PATH = '/api/v1/network/posts/get-feed';
