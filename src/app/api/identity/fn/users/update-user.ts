...
export function updateUser(http: HttpClient, rootUrl: string, params?: UpdateUser$Params, context?: HttpContext): Observable<StrictHttpResponse<StatusCodeResult>> {
...
updateUser.PATH = '/api/v1/identity/users';
