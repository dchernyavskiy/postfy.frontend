...
export class NetworkApiClient extends ClientBase {
    ...
    protected processGetCommentsByPostId(response: HttpResponseBase): Observable<GetCommentsByPostIdResponse> {
        ...
        if (status === 201) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result201: any = null;
            result201 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as GetCommentsByPostIdResponse;
            return _observableOf(result201);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Created
     */
    createPost(body: CreatePost | undefined): Observable<CreatePostResponse> {
     ...
     * @return Created
     */
    getPosts(includes: string[] | undefined, filters: FilterModel[] | undefined, sorts: string[] | undefined, page: number | undefined, pageSize: number | undefined): Observable<GetPostsResponse> {
        let url_ = this.baseUrl + "/api/v1/network/posts?";
        if (includes === null)
    ...
    protected processGetPosts(response: HttpResponseBase): Observable<GetPostsResponse> {
        ...
        if (status === 201) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result201: any = null;
            result201 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as GetPostsResponse;
            return _observableOf(result201);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    protected processGetFeed(response: HttpResponseBase): Observable<GetFeedResponse> {
        ...
        if (status === 201) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result201: any = null;
            result201 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as GetFeedResponse;
            return _observableOf(result201);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
